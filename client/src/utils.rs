...
pub fn parse_secret_file(path: &Path) -> Result<SecretFileData> {
...
pub fn resolve_secret(secret: Option<String>, secret_file: Option<PathBuf>) -> Result<[u8; 32]> {
...
///
/// Returns an error if neither or both sources are provided.
pub fn resolve_secret_with_metadata(
